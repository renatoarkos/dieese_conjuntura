...
| 🟢 CONFIRMADO (fonte manual/pública sem tabela extraível) | 3 | INDATEND (identificado como planilha interna do DIEESE, E definitivo); ICT; Greves — número/categorias/reivindicações (PDF-imagem, sem OCR) |
